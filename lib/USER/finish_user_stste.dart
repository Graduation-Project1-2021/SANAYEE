...
class finished_user_statues extends StatefulWidget {
  ...
  final name_Me;
  final id;
  finished_user_statues({this.id,this.name_Me,this.AVG,this.work,this.timesend,this.datesend,this.time,this.date,this.country,this.namefirst,this.namelast,this.image,this.phoneuser,this.phoneworker,this.description});
