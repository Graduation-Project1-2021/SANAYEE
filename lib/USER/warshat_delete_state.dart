...
class delete_warshat_statues extends StatefulWidget {
  ...
  final to;
  final type;
  delete_warshat_statues({this.from,this.to,this.type,this.id,this.name_Me,this.AVG,this.work,this.timesend,this.datesend,this.time,this.date,this.country,this.namefirst,this.namelast,this.image,this.phoneuser,this.phoneworker,this.description});
