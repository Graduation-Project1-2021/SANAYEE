...
import 'package:flutterphone/Worker/setting_worker.dart';
  ...
  class change extends StatefulWidget{
    ...
    change({this.name, this.phone, this.image, this.Work, this.Experiance, this.Information, this.token});
          ...
          child: GestureDetector(
            ...
            child: ListView(
              children: [
                ...
                child:TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    suffixIcon: IconButton(
                      icon: Icon(_showPassword1 ? Icons.visibility : Icons.visibility_off, color: Colors.black,),
                      color: Colors.cyan,
                ...
                Pass_old ? Container(): Container(
                  margin: EdgeInsets.fromLTRB(255, 0, 0, 1),
                ...
                Pass_old_notC ? Container(): Container(
                  margin: EdgeInsets.fromLTRB(205, 0, 0, 1),
                  child: Text('كلمة السر القديمة غير صحيحة',textAlign:TextAlign.end,
                    style: TextStyle(
                      fontSize: 12.0,
                      fontWeight: FontWeight.w700,
                      fontFamily: 'Changa',
                ...
                Container(margin: EdgeInsets.symmetric(vertical: 25.0),),
            Container(
              margin: EdgeInsets.symmetric(horizontal: 10),
                child:TextFormField(
                  validator: (value) {
                  ...
                  decoration: InputDecoration(
                    ...
                    suffixIcon: IconButton(
                      icon: Icon(_showPassword2 ? Icons.visibility : Icons.visibility_off, color: Colors.black,),
                      color: Colors.cyan,
                ...
                Pass_S ? Container(): Container(
                  margin: EdgeInsets.fromLTRB(135, 0, 0, 1),
              ...
              child:TextFormField(
                ...
                validator: (value) {
                  ...
                  decoration: InputDecoration(
                    ...
                    suffixIcon: IconButton(
                      icon: Icon(_showPassword3 ? Icons.visibility : Icons.visibility_off, color: Colors.black,),
                      color: Colors.cyan,
                ...
                Pass_Mismatch ? Container(): Container(
                  margin: EdgeInsets.fromLTRB(235, 0,0, 1),
